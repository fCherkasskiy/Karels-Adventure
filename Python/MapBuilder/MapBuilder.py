...
row = []
col = []
colors = ["black", "#ffffff", "red", "blue", "green", "#00ffff", "#ffff00", "#ffa500"]
...
canvas2.create_rectangle((2, 400), (40, 440),
                         outline="black", fill="black")

canvas2.create_rectangle((40, 400), (80, 440),
                         outline="green", fill="green")

canvas2.create_rectangle((2, 440), (40, 480),
                         outline="red", fill="red")

canvas2.create_rectangle((40, 440), (80, 480),
                         outline="blue", fill="blue")

canvas2.create_rectangle((2, 400), (40, 320),
                         outline="#ffffff", fill="#ffffff")

canvas2.create_rectangle((40, 400), (80, 320),
                         outline="#ffa500", fill="#ffa500")

canvas2.create_rectangle((2, 400), (40, 360),
