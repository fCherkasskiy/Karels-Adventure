...
public class Editor extends JFrame {
    ...
    public class Move implements MouseMotionListener{
        ...
        /**
         * Determines mouse position when mouse is clicked and dragged
         * @param e Mouse Event
         */
        ...
        /**
         * Determines mouse position when mouse is moved
         * @param e Mouse Event
         */
    ...
    public class Pressed implements MouseListener {
        ...
        /**
         * Changes clicked status when clicked
         * @param e Mouse Event
         */
        ...
        /**
         * Changes clicked status when released
         * @param e Mouse Event
         */
...
class Listener1 implements ActionListener{
    /**
     * Asks for filename, map type, jump velocity, and walking block color and saves the file
...
class Listener3 implements ActionListener
{
    ...
    /**
     * Asks user for color selection to fill the screen
     * @param e Action Event
     */
