...
//Cavnas,JPanel
{
    ...
    public AnimationPh2() { addKeyListener(this); }
    ...
    public static void main(String[] args) throws Exception {
        ...
        int len = longi*latit;
        System.out.println(len + " " + longi + " " + latit);
...
//        tm.start();
    ...
    public void saveGnd(Integer[] grnd) {
         for (int r=0; r<longi;r++) System.out.println(grnd[r]);
        gnd=grnd;
    }

    public Integer[] getGnd() { return gnd; }
    ...
    public void actionPerformed(ActionEvent e) {
        if (getGnd()!=null) {
            ...
            top=Math.max(grounddata[xr],grounddata[x / 10]) * 10 + 44;
//            System.out.println(top);
//             for (int r=0; r<longi;r++) System.out.println(grounddata[r]);
        }
        if (x < 0) {
            velx=0;
            x=0;
